...
<head>
    ...
    <title>Sinh viên - Báo cáo đồ án </title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">NỘP BÁO CÁO ĐỒ ÁN NGHIÊN CỨU KHOA HỌC</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <h1>NỘP BÁO CÁO NGHIÊN CỨU KHOA HỌC</h1>
                                <h4>THAM GIA NGHIÊN CỨU KHOA HỌC NĂM 2023</h4>
                            </div>
                            <form  action="<%= request.getContextPath() %>/DETAI/Detai_BaoCao"  method= "post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <h4>3.Nộp báo cáo nghiên cứu khoa học : </h4>
                                    </div>
                                    <label for="MaDT" class="form-label">Chọn tên đề tài muốn nộp báo cáo: </label>
                                    <div>
                                ...
                                <div class="mb-3">
                                    <label for="GhiChu" class="form-label">Mô tả đề tài :</label>
                                    <textarea id="GhiChu" name="GhiChu" class="form-control" rows="4"></textarea>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success" >Xác nhận gửi báo cáo đề tài</button>
                                </div>
                            </form>
                        </div>
                    </div>

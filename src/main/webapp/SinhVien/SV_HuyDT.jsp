...
<head>
    ...
    <title>Sinh viên - Trang hủy đề tài</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <h1>ĐƠN XIN HỦY ĐỀ TÀI</h1>
                                <h4>THAM GIA NGHIÊN CỨU KHOA HỌC NĂM 2023</h4>
                            </div>
                            <form action="<%= request.getContextPath() %>/DETAI/Detai_Huy" method= "post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <h4>3.Thông tin hủy đề tài : </h4>
                                    </div>
                                    <label for="MaDT" class="form-label">Chọn tên đề tài : </label>
                                ...
                                <script>
                                    ...
                                    document.getElementById('NgayHuy').value = formattedDate;
                                </script>
                                <div class="mb-3">
                                    <label for="GhiChu" class="form-label">Lý do hủy đề tài :</label>
                                    <textarea id="GhiChu" name="GhiChu" class="form-control" value = "${dangky.ghiChu}"  rows="4"></textarea>
                                </div>

                                <div class="text-center">
                                    <button type="submit" class="btn btn-success" >Xác nhận gửi đơn hủy đề tài</button>
                                </div>
                            </form>
                        </div>
                    </div>

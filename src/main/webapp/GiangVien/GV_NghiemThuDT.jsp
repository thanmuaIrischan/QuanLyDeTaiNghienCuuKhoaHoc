...
<head>
    ...
    <title>Giảng viên - Nghiệm thu đề tài</title>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">NGHIỆM THU ĐỀ TÀI</h1>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Nghiệm thu đề tài</h6>
                    </div>

                    <div class="card-body">
                        <div class="text-center">
                            <h1>QUY TRÌNH NGHIỆM THU ĐỀ TÀI</h1>
                            <h4>THAM GIA NGHIÊN CỨU KHOA HỌC NĂM 2023</h4>
                        </div>
                        <form action="<%= request.getContextPath() %>/DetaiIMPLE/GV_NghiemThuDeTai" method= "post">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class= "row">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="NhanXetDT">Đánh giá đề tài:</label>
                                            <textarea class="form-control" id="NhanXetDT" name="NhanXetDT" rows="4" cols="100">${bbnt.nhanXet}</textarea>
                                        </div>
                                    </div>
                                    <div class = "row">
                                            <div class="form-group">
                                                <label for="DiemDT">Điểm HDNT: </label>
                                                <input type="text" value = "${bbnt.diem}" class="form-control" id="DiemDT" name="DiemDT">
                                            </div>
                                    </div>
                                    <div class ="row">
                                            <div class="form-group">
                                                <label for="LinkBBNT">Link biên bản nghiệm thu :</label>
                                                <input type="text" class="form-control" id="LinkBBNT" name="LinkBBNT" value = "${bbnt.linkBB}">
                                            </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <!-- Textbox 4 -->
                                        <div class="form-group">
                                            <label for="NhanXet">Đánh giá đề tài:</label>
                                            <textarea class="form-control" id="NhanXet" name="NhanXet" value = "" rows="4" cols="100"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <!-- Textbox 1 -->
                                        <div class="form-group">
                                            <label for="Diem">Chấm điểm đề tài : </label>
                                    ...
                                    <div class="col-md-6">
                                        <!-- Textbox 4 -->
                                        <div class="form-group">
                                            <label for="LinkBB">Link biên bản nghiệm thu :</label>
                                            <input type="text" class="form-control" id="LinkBB" name="LinkBB">
                                        </div>
                                    </div>
                                </div>
                                <div class = "row" >
                                    <div class="col-md-12">
                                        <label for="NgayNghiemThu" class="form-label">Ngày nghiệm thu đề tài :</label>
                                        <input type="date" id="NgayNghiemThu" name="NgayNghiemThu" value="${exdetai.ngayKetThuc}" class="form-control" readonly>
                                    </div>
                                </div>
                            ...
                            <script>
                                ...
                                document.getElementById('NgayNghiemThu').value = formattedDate;
                            </script>
                            <br>

                            <div class="text-center mt-6">
                                <button type="submit" class="btn btn-primary" style="width: 30%;">Xác nhận nghiệm thu DT</button>
                            </div>
                            </div>
                        </form>
                    </div>

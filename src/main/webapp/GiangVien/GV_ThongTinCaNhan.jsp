...
<head>
    ...
    <title>Giảng viên - Thông tin cá nhân</title>
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card-body">
                                    <table>
                                        ...
                                        <tr>
                                            <td>Ngày sinh:</td>
                                            <td>
                                                <fmt:formatDate value="${thongtingiangvien.ngaySinh}" pattern="dd/MM/yyyy" />
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Thông tin nghiệp vụ </h6>
                                </div>
                                <div class="card-body">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>    </td>
                                            <td>
                                                ${thongtingiangvien.taikhoan.tenLoaiTK}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Mã khoa:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>    </td>
                                            <td>
                                                ${thongtingiangvien.khoa.tenKhoa}
                                                <!-- fix khóa ngoại -->
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <div class="card-body">
                                        <table>
                                            ...
                                            <tr>
                                                <td>Email: </td>
                                                <td> </td>
                                                <td>${thongtingiangvien.taikhoan.email}</td>
                                            </tr>

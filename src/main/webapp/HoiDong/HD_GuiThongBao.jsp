        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
    			...
    			<div class="container-fluid">
                    ...
                    <form action="<%= request.getContextPath() %>/ThongBao/ThemThongBao" method = "post" >
                    <!-- Page Heading -->
                    <h1 class="h3 font-weight-bold text-primary text-uppercase mb-1">Tạo thông báo</h1>
                    <div class="card mb-4">
                         <div class="card-header">Thêm thông báo</div>
                         <div class="card-body" style="height: 100%">
                             <div class="mb-3">
                                 <label for="MaTB" class="form-label">Mã thông báo:</label>
                                 <input type="text" class="form-control" id="MaTB" name="MaTB">
                             </div>

                             <div class="mb-3">
                                 <label for="TenThongBao" class="form-label">Tên thông báo:</label>
                                 <input type="text" class="form-control" id="TenThongBao" name="TenThongBao">
                             </div>

                             <div class="mb-3">
                                 <label for="NoiDungTB" class="form-label">Nội dung thông báo:</label>
                                 <textarea class="form-control" id="NoiDungTB" rows="2" name="NoiDungTB"></textarea>
                             </div>
                             ...
                             <script>
                                 ...
                                 document.getElementById('NgayGui').value = formattedDate;
                             </script>
                         </div>
                     </div>
                    </form>

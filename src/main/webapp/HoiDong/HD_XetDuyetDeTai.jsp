        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id = "content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">VĂN BẢN TIẾN TRÌNH XÉT DUYỆT ĐỀ TÀI NGHIÊN CỨU KHOA HỌC </h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Quy trình hiện hành văn bản chính thức</h6>
                        </div>

                        <div class="card-body">
                            <div class="text-center">
                                <h1>QUY TRÌNH XÉT DUYỆT ĐỀ TÀI NGHIÊN CỨU KHOA HỌC</h1>
                                <h4>THAM GIA NGHIÊN CỨU KHOA HỌC NĂM 2023</h4>
                            </div>
                            <form action="<%= request.getContextPath() %>/QuanLyHoiDong/XetDuyetDeTaiChung" method= "post">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class= "row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="LinkBBDC">Link biên bản xét duyệt đề cương :</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <h4>3. Tổng kết  : </h4>
                                        <label for="MaTrangThai_change">Xét duyệt đề cương đề tài:</label>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div>
                                                        <select id = "MaTrangThai_change" name = "MaTrangThai_change" style="width: 100%;" >
                                        ...
                                        <div class="text-center mt-6">
                                            <button type="submit" class="btn btn-primary" style="width: 30%;">Xác nhận thay đổi trạng thái</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

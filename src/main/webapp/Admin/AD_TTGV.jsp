    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form action="<%= request.getContextPath() %>/giangvien/AD_updateGiangVien"  method="post">
                    <input type="hidden" name="MSGV" value="<c:out value="${gv.msgv}"/>">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" value="<c:out value="${gv.msgv}"/>" id="MSGV" name="MSGV" class="form-control" style= "margin-left: 30px; width: 300px" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Họ tên giảng viên:</td>
                                            <td>
                                                <input type="text" value="<c:out value="${gv.tenGV}"/>" id="TenGV" name="TenGV" class="form-control" style= "margin-left: 30px; width: 300px" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Ngày sinh:</td>
                                            <td>
                                                <input type="date" value="<c:out value="${gv.ngaySinh}"/>" id="NgaySinh" name="NgaySinh" class="form-control" style= "margin-left: 30px; width: 300px" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>CCCD:</td>
                                            <td>
                                                <input type="text" value="<c:out value="${gv.cccd}"/>" id="CCCD" name="CCCD" class="form-control" style= "margin-left: 30px; width: 300px" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Giới tính:</td>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label>Chức vụ : </label>
                                        <input type="text" value="<c:out value="${gv.taikhoan.tenLoaiTK}"/>" id="TenLoaiTK" name="TenLoaiTK" class="form-control" style= "margin-left: 30px; width: 300px" readonly>
                                    </div>

                                    <div class="form-group" >
                                        <label for="MaHD">Hội đồng</label>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <input type="email" value="<c:out value="${gv.taikhoan.email}"/>" id="Email" name="Email" class="form-control" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Số điện thoại:</td>
                                                <td></td>
                                                <td>
                                                    <input type="text" value="<c:out value="${gv.sdt}"/>" id="Sdt" name="Sdt" class="form-control" style= "margin-left: 30px; width: 300px" >
                                                </td>
                                            </tr>
